...
<div style = "margin-top: 100px; height: 100px; length = 300px; 
            border: solid; padding: 20px; background-color: white; font-size: larger;">
    <p>Your account is awaiting verification. Try to sign in after 10 minutes.
        Click <a href  = "home.php" style="text-decoration: underline; color: #F36E39;">here</a> to go to the home page.
    </p>
</div>
