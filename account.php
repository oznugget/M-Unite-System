...
if ($stmt) {
    ...
    if ($result->num_rows > 0) {
        ...
        // BUG FIX: this page previously had no role check at all - it would
        // display ANY logged-in user's data (officer, admin, councillor),
        // not just residents, since the query above never filters by role.
        if ($userData['role'] !== 'Community Member') {
            $error = "This page is for Community Member accounts only.";
            $userData = null;
        }
    } else {
        ...
        <?php if ($userData): ?>
            <div class="reg-form">
                ...
                <div class="form-actions" style="display: flex; gap: 10px;">
                    <a href="resident-update-account.php" style="width: 100%;">
